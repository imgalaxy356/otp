...
RENDER_URL = os.getenv("RENDER_URL")  # e.g., https://otp-xxxx.onrender.com
...
def set_webhook():
    ...
    try:
        fut = asyncio.run_coroutine_threadsafe(application.bot.set_webhook(webhook_url), application.bot.loop)
